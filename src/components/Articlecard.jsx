...
const Articlecard = ({ article }) => {
  ...
  return (
    <Link
      href={`/artikel/${slug}`}
      className="block flex flex-col sm:flex-row gap-6 items-center bg-white/80 backdrop-blur-md 
      border border-[var(--color-primary-light)]/15 rounded-2xl p-5 shadow-md 
